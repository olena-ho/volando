...
export const HotelCard = ({ hotel, activities, onRemoveFromFavorites, onHotelClick, isFavorite, onAddToFavorites, handleOpenHotelDetails, isHotelDetailsOpened}) => {
  ...
  return (
    <div className="hotel-card" onClick={() => onHotelClick(hotel)}>
      ...
      <div className="favorite-container">
        ...
        ></button>
        <button className={`arrow-details ${isHotelDetailsOpened ? 'active' : 'inactive'}`}
          onClick={(e) => {
            e.stopPropagation();
