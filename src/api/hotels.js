const hotels = [
  ...
  },
  {
    ...
    price: 'budget',
    description:
      'Located in the heart of Vinnytsia, Hotel France offers elegant accommodations with a restaurant, free Wi-Fi, and various activities for guests, including cycling and walking tours. The hotel also features live performances and has a historical charm.',
  ...
  },
  {
    ...
    images: [],
    defaultReviews: [
      { name: 'Василь', date: '01.06.2023 10:00', text: 'Чудове місце!' },
      { name: 'Eva', date: '02.06.2023 12:00', text: 'Skvělý zážitek.' },
      { name: 'John', date: '03.06.2023 14:00', text: 'Nice amenities.' },
    ]
  },
  {
    id: 50,
    ...
    images: [],
    defaultReviews: [
      { name: 'Ігор', date: '01.06.2023 10:00', text: 'Чудовий готель!' },
      { name: 'Eva', date: '02.06.2023 12:00', text: 'Velmi dobré služby.' },
      { name: 'John', date: '03.06.2023 14:00', text: 'Nice facilities.' },
    ]
  },
  {
    id: 51,
    ...
    images: [],
    defaultReviews: [
      { name: 'Ірина', date: '01.06.2023 10:00', text: 'Розкішний готель!' },
      { name: 'Eva', date: '02.06.2023 12:00', text: 'Úžasný zážitek.' },
      { name: 'John', date: '03.06.2023 14:00', text: 'Luxurious experience.' },
    ]
  },
  {
    id: 52,
    ...
    price: 'luxury',
    description:
      'Lisotel is a recreation center near Kyiv, located in the pine forest on the banks of the Ros River. The main feature of our complex is our love for the Ukrainian history and traditions.',
    comfort: [
      'wifi',
      'parking',
      'pool',
